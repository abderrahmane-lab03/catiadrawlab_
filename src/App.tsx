...
export default function App() {
  ...
  // SVG placeholder (data URL) for coming-soon entries or missing images
  const comingSoonSvg = encodeURIComponent(`
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1200 750'>
      ...
      <g filter='url(%23b)'>
        <circle cx='600' cy='375' r='300' fill='%2393c5fd' opacity='0.18' />
      </g>
      <text x='50%' y='52%' dominant-baseline='middle' text-anchor='middle' font-family='Inter, Arial, Helvetica, sans-serif' font-size='56' fill='%23626f7a' font-weight='700'>Coming Soon</text>
    </svg>
  `);
  const comingSoonDataUrl = `data:image/svg+xml;utf8,${comingSoonSvg}`;

  const getDownloadFilename = (url: string | undefined, id: string) => {
    if (!url || url === '#') return undefined;
    const cleaned = url.split('?')[0];
    const m = cleaned.match(/\.([a-z0-9]+)$/i);
    return m ? `${id}.${m[1]}` : `${id}.pdf`;
  };
        ...
        <nav className="max-w-3xl mx-auto pointer-events-auto">
          ...
          >
            ...
            <div className="hidden md:flex items-center pl-4">
              <a
                href="https://www.youtube.com/channel/UCh5shRiawrHhkaCw4gw0d3g"
                target="_blank"
                        ...
                        {filteredDrawings.map((drawing: Drawing, index: number) => (
                          ...
                          >
                            ...
                            <div className="aspect-[16/10] overflow-hidden relative border-b border-slate-200">
                              <img 
                                src={drawing.isComingSoon || !drawing.image ? comingSoonDataUrl : drawing.image} 
                                alt={drawing.name}
                              ...
                              {!drawing.isComingSoon && (
                                <div className="absolute inset-0 bg-slate-900/30 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3 backdrop-blur-[2px]">
                                  ...
                                  <a 
                                    ...
                                    download={getDownloadFilename(drawing.downloadUrl, drawing.id)}
                              ...
                              <div className="mt-auto relative pt-4 border-t border-slate-100">
                                ...
                                <div className="flex items-center justify-between transition-all duration-300">
                                  <div className="flex flex-wrap gap-1">
                                    {drawing.tools.slice(0, 2).map((tool: string) => (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                  ...
                  <div className="lg:col-span-2 space-y-6 md:space-y-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {selectedDrawing.tools.map((tool: string) => (
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-4">
                          <a 
                            ...
                            download={getDownloadFilename(selectedDrawing.downloadUrl, selectedDrawing.id)}
                  ...
                  <aside className="space-y-8">
                    ...
                    <div className="glass-card p-6 rounded-xl block">
                       ...
                       <a href="https://www.youtube.com/channel/UCh5shRiawrHhkaCw4gw0d3g" target="_blank" rel="noopener noreferrer" className="w-full bg-[#FF0000] hover:bg-[#CC0000] text-white tech-button-base py-2 transition-colors inline-flex items-center justify-center gap-3">
